...
# Packages: os, Cryptodome
# Day 06 of NaSWriMo
# Description: encrypt specified file 
# Packages: os, Cryptodome
...
def encrypt_data(file_path = False):
    ...
    if file_path != False:
        ...
        # example data
        data = "Super secret original secrets".encode("utf-8")
...
def decrypt_data(file_path = False):
    ...
    with open("demo/encrypted.bin", "rb") as content_file:
...
if __name__ == "__main__":
    ...
    if in_file:
        encrypt_data(in_file)
    else:
        encrypt_data()
    print("[+] Encryption complete...")
    print("[-] Attempting decryption...")
    if in_file:
        decrypt_data(in_file)
    else:
        decrypt_data()